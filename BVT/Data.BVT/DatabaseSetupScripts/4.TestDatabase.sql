-- ===============================================
-- 
-- Configure Data Access Quick Starts TestDatabase Database
-- 
-- ===============================================
...
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'TestDatabase')
	DROP DATABASE [TestDatabase]

GO

IF NOT (EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'TestDatabase'))
	CREATE DATABASE [TestDatabase]
GO

--exec sp_dboption N'TestDatabase', N'autoclose', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'bulkcopy', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'trunc. log', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'torn page detection', N'true'
--GO

--exec sp_dboption N'TestDatabase', N'read only', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'dbo use', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'single', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'autoshrink', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'ANSI null default', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'recursive triggers', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'ANSI nulls', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'concat null yields null', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'cursor close on commit', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'default to local cursor', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'quoted identifier', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'ANSI warnings', N'false'
--GO

--exec sp_dboption N'TestDatabase', N'auto create statistics', N'true'
--GO

--exec sp_dboption N'TestDatabase', N'auto update statistics', N'true'
--GO
...
GO
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[CustomersOrders]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[CustomersOrders]
GO
...
CREATE TABLE [dbo].[Items] (
	[ItemID] [int] NOT NULL,
	[ItemDescription] [nchar] (20) NOT NULL ,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ItemsGet]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ItemsGet]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ItemsDescriptionGet]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ItemsDescriptionGet]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ItemGetByPrice]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ItemGetByPrice]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ItemPriceGetbyId]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ItemPriceGetbyId]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ItemQuantityIncrease]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ItemQuantityIncrease]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ItemQuantityUpdateById]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ItemQuantityUpdateById]
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[CustomerOrdersAdd]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[CustomerOrdersAdd]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[CustomerOrdersAddwithParm]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[CustomerOrdersAddwithParm]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[CustomerOrdersAddwithOutParm]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[CustomerOrdersAddwithOutParm]
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[AddrowSelect]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[AddrowSelect]
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[UpdateItem]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[UpdateItem]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[Addparams]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[Addparams]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[itemsgetxml]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[itemsgetxml]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[itemsgetTimeOutxml]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[itemsgetTimeOutxml]
GO
-- =======================================================
-- Create triggers
-- =======================================================
...
Create Procedure ItemsDescriptionGet
as 
begin
select ItemDescription from Items where itemId = 1
end
go

--/////////////////////////////////////////////////////////////////////

Create Procedure dbo.ItemGetByPrice
@Price money 
 as
...
Create Procedure dbo.ItemPriceGetbyId
@Id int,
@Price money out
 as
Select @Price = Price from Items where ItemId=@Id
select * from Items
GO

--/////////////////////////////////////////////////////////////////////

Create Procedure dbo.ItemQuantityIncrease

 as
Update Items set QtyRequired = QtyRequired  + 10
Select * from Items order by ItemId
go

--/////////////////////////////////////////////////////////////////////

Create Procedure dbo.ItemQuantityUpdateById

@ItemId int=1,
@Quantity int = 50
 as
Update Items set QtyinHand = @Quantity where ItemID = @ItemId
Select * from Items Order by ItemID
GO
...
Create Procedure dbo.OrderUpdate
 as
Update CustomersOrders set QtyOrdered = 150
Select max(QtyOrdered)  from CustomersOrders

GO

--/////////////////////////////////////////////////////////////////////

Create Procedure dbo.CustomerOrdersAdd
 as
Insert into CustomersOrders values(11, 'David',3, 555)
Select CustomerName from CustomersOrders where customerId = 11
GO

--/////////////////////////////////////////////////////////////////////

Create Procedure dbo.CustomerOrdersAddwithParm
@CustomerId int = 12,
@CustomerName varchar(80),
@ItemId int,
@QtyOrdered int
 as
Insert into CustomersOrders values(@CustomerId, @CustomerName,@ItemId, @QtyOrdered)
Select QtyOrdered from CustomersOrders where customerName = @CustomerName
go

--/////////////////////////////////////////////////////////////////////

Create Procedure dbo.CustomerOrdersAddwithOutParm
@CustomerId int,
@QtyOrdered varchar(80) OUT 
 as
Update CustomersOrders set QtyOrdered = 234 where customerId = @CustomerId
Select @QtyOrdered = QtyOrdered from CustomersOrders where customerId = @CustomerId
go
...
INSERT INTO  
  Items (ItemID, ItemDescription, Price, QtyinHand, QtyRequired)
VALUES 
  (@ItemID, @ItemDescription, @Price, @QtyinHand, @QtyRequired)
...
CREATE PROCEDURE dbo.AddrowSelect
	
AS
	begin
	Insert into  Items values(4, 'Infotech', 88, 35, 100)
	Select * from Items order by ItemID 
	end
...
CREATE PROCEDURE dbo.Addparams
...
CREATE PROCEDURE dbo.itemsgetxml
	
AS
	begin
	Select ItemDescription from Items FOR XML AUTO
end
GO

--/////////////////////////////////////////////////////////////////////

CREATE PROCEDURE dbo.itemsgetTimeOutxml
...
INSERT INTO [Items] ([ItemID],[ItemDescription],[Price],[QtyinHand],[QtyRequired]) VALUES (1, 'Digital Image Pro',38.95,25, 100)
INSERT INTO [Items] ([ItemID],[ItemDescription],[Price],[QtyinHand],[QtyRequired]) VALUES (2, 'Excel 2003', 98.95, 95, 100)
INSERT INTO [Items] ([ItemID],[ItemDescription],[Price],[QtyinHand],[QtyRequired]) VALUES (3, 'Infopath', 89, 34, 100) 

--/////////////////////////////////////////////////////////////////////


INSERT INTO [CustomersOrders] ([CustomerID],[CustomerName],[ItemID],[QtyOrdered]) VALUES (1, 'Eastaff', 1, 100)
INSERT INTO [CustomersOrders] ([CustomerID],[CustomerName],[ItemID],[QtyOrdered]) VALUES (2, 'Tom', 2, 100)
INSERT INTO [CustomersOrders] ([CustomerID],[CustomerName],[ItemID],[QtyOrdered]) VALUES (3, 'Jack', 1, 100)

create table DTCTable(eno int  constraint PK_DTCTable  Primary key ,ename varchar(25)  )

create table TestNullTable(eno int constraint PK_TestNullTable Primary Key,ename varchar(25),age int)
go
CREATE PROCEDURE dbo.TestNullType(@eno int, @ename varchar(25),@age int)

as 

begin

insert into TestNullTable Values(@eno,@ename,@age)
